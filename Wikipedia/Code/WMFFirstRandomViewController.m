    ...
    [fetcher fetchRandomArticleWithSiteURL:siteURL
                                completion:^(NSError *_Nullable error, NSURL *_Nullable articleURL, WMFArticleSummary *_Nullable summary) {
                                    dispatch_async(dispatch_get_main_queue(), ^{
                                        ...
                                        WMFRandomArticleViewController *randomArticleVC = [[WMFRandomArticleViewController alloc] initWithArticleURL:articleURL dataStore:self.dataStore theme:self.theme schemeHandler: SchemeHandler.shared];
